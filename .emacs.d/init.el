...
(use-package taemin
  ...
  (("<f5>" . taemin-makefile-compile)
   ...
   ("<f6>" . taemin-terminal-other-window-reuse)
   ("<S-f6>" . taemin-terminal-other-window)
   ("M-s o" . taemin-occur))
  :config
...
(custom-set-faces
 ...
 '(mode-line ((t (:box (:line-width (1 . -1) :style released-button) :foreground "white" :background "grey30"))))
 '(mode-line-inactive ((t (:weight light :box (:line-width (1 . -1) :color "grey40") :foreground "grey40" :background "unspecified-bg" :inherit mode-line)))))
